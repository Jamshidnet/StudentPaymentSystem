...
public class TokenService :ITokenService
{
    ...
    public async Task<Tokens> CreateTokensAsync(AUser user)
    {
    ...
    {
        await _dbContext.UserRefreshToken.AddAsync(tokens);
    ...
    {
        _dbContext.UserRefreshToken.Update(tokens);
    ...
    {
        return _dbContext.UserRefreshToken.Where(predicate);
    }
